...
public enum ErrorCode {
	...
	CATEGORY_MISMATCH(HttpStatus.BAD_REQUEST, "SUP_007", "유효하지 않은 카테고리 계층입니다."),
	...
	// 알림
	NOTIFICATION_MESSAGE_SERIALIZATION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "NTF_001", "알림 메시지 직렬화에 실패했습니다."),
	NOTIFICATION_MESSAGE_BUILDER_NOT_FOUND(HttpStatus.INTERNAL_SERVER_ERROR, "NTF_002", "알림 메시지 빌더를 찾을 수 없습니다."),
	NOTIFICATION_JSON_PARSE_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "NTF_003", "알림 메시지 JSON 파싱에 실패했습니다."),

	// 카카오 워크
	KAKAO_WORK_FETCH_USER_ID_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "KAKAO_001", "카카오 워크 ID 조회에 실패했습니다."),
	KAKAO_WORK_OPEN_CONVERSATION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "KAKAO_002", "카카오 워크 대화방 열기에 실패했습니다."),
	KAKAO_WORK_SEND_MESSAGE_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "KAKAO_003", "카카오 워크 메시지 전송에 실패했습니다.");
